...
**迁移文件位置**: `docs/migrations/`

**注意**: 本项目不使用 Prisma Migrate，所有数据库变更必须手写 SQL 迁移脚本。

---

### 2. check-migrations.sh - 迁移状态检查
...
### 3. setup-secrets.sh - GitHub Secrets 配置助手
