...
import { FileTextOutlined, SettingOutlined, UserOutlined, BookOutlined, ClusterOutlined, SearchOutlined, SoundOutlined } from "@ant-design/icons";
...
export default function CLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!loading && user) {
      ...
      const adminOnlyPaths = ['/c/collections', '/c/config', '/c/user', '/c/queue', '/c/vector-search', '/c/tts'];
