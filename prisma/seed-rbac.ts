...
const seedApiRegistry: ApiRegistrySeed[] = [
  ...
  },
  {
    ...
    name: 'AI Lab 导入旧模板',
    module: 'ai_lab',
    api_path: '/api/admin/ai-lab/prompts/import-legacy',
    api_method: 'POST',
    mcp_enabled: false,
    permission_code: 'config:edit',
  },
  ...
  {
    code: 'create_templates_list',
    name: '模板列表',
    module: 'create',
    api_path: '/api/create/templates',
    api_method: 'GET',
    mcp_enabled: false,
    permission_code: 'content:view',
  },
  {
    code: 'create_templates_create',
    name: '创建模板',
    module: 'create',
    api_path: '/api/create/templates',
    api_method: 'POST',
  ...
  {
    code: 'create_templates_get',
    name: '模板详情',
    module: 'create',
    api_path: '/api/create/templates/[id]',
    api_method: 'GET',
    mcp_enabled: false,
    permission_code: 'content:view',
  },
  {
    code: 'create_templates_update',
    name: '更新模板',
    module: 'create',
    api_path: '/api/create/templates/[id]',
    api_method: 'PATCH',
  ...
  {
    code: 'create_templates_import_xhs',
    name: '导入小红书模板',
    module: 'create',
    api_path: '/api/create/templates/import-xhs',
    api_method: 'POST',
    mcp_enabled: false,
    permission_code: 'content:create',
  },
